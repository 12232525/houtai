...
<style>
.gold { background: url("{$Config.siteurl}statics/themes/default/member/images/integra_bg.jpg") no-repeat 0 -640px;width:750px;display: inline;float: left;margin:0 15px;height:277px;position: relative;}
...
.gold .box .receive{ background: url("{$Config.siteurl}statics/themes/default/member/images/integra_but.png") no-repeat 0 -216px;_background: url("{$Config.siteurl}statics/themes/default/member/images/integra_but.gif") no-repeat 0 -216px;width:82px;height:31px;line-height: 29px;border: 0 none;color: #ffffff;cursor: pointer;display: inline;float: left;text-indent: -9999px;margin-left:40px;}
...
/*账号绑定*/
			...
			#accountBindContent ul li span.qqBind{ background:url({$Config.siteurl}statics/themes/default/member/images/bindBtn.png) no-repeat 0 0;height:64px;width:64px;}
			#accountBindContent ul li span.sinaBind{ background:url({$Config.siteurl}statics/themes/default/member/images/bindBtn.png) no-repeat 0 -74px;height:64px;width:64px;}
