...
<link rel="stylesheet" type="text/css" href="{$Config.siteurl}statics/themes/default/member/css/common.css" media="all"/>
...
<div class="user">
  <div class="center">
    ...
    <div class="main"></div>
    <form method="post" action="{:U('Share/edit')}" id="myform" name="myform" class="J_ajaxForms" enctype="multipart/form-data">
        ...
        <ul class="danceAddMain_left">
          ...
          <li>
            ...
            <div id="btnUploadBox" class="dA_input">
              ...
              <input name="dosubmit" type="submit" id="dosubmit" value="修改" class="button"/>
            </div>
          </li>
          </if>
        </ul>
