...
<style>
/*tip message start*/
.tip_message,.tip_message .tip_ico_succ,.tip_message .tip_ico_fail,.tip_message .tip_ico_hits,.tip_message .tip_content,.tip_message .tip_end{ background-image:url({$Config.siteurl}statics/themes/default/member/images/tip_message.png);_background-image:url({$Config.siteurl}statics/themes/default/member/images/tip_message_ie6.png);color:#606060;float:left;font-size:14px;font-weight:bold;height:54px;line-height:54px;}
      ...
      <div  class="register_box_right">
        ...
        <ul class="clear">
         <volist name="heat" id="vo">
          <li> <a target="_blank" href="{:UM('Home/index',array('userid'=>$vo['userid']))}"> <img src="{:U('Api/Avatar/index',array('uid'=>$vo['userid'],'size'=>48))}" onerror="this.src='{$Config.siteurl}statics/themes/default/member/images/noavatar.jpg'"> </a> </li>
        </volist>
        </ul>
      </div>
    </div>
...
<script type="text/javascript" src="{$Config.siteurl}statics/themes/default/member/js/sinabinding.js"></script>
