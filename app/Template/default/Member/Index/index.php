...
<link type="text/css" href="{$Config.siteurl}statics/themes/default/member/css/core.css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="{$Config.siteurl}statics/themes/default/member/css/common.css" />
<link type="text/css" href="{$Config.siteurl}statics/themes/default/member/css/user.css" rel="stylesheet" media="all" />
</head>
<body>
      ...
      <div class="uMain_home_right">
        ...
        <ul class="sFriend">
           <volist name="visitors" id="vo">
            <li>
              <div class="friendAvatar"><a href="{:UM('Home/index',array('userid'=>$vo['userid']))}" class="user_card" uid="{$vo['userid']}"><img width="48" height="48" src="{:U('Api/Avatar/index',array('uid'=>$vo['userid'],'size'=>48))}" onerror="this.src='{$Config.siteurl}statics/themes/default/member/images/noavatar.jpg'"/></a></div>
        ...
        <ul class="sFriend">
          <volist name="friends" id="vo">
            <li>
              <div class="friendAvatar"><a href="{:UM('Home/index',array('userid'=>$vo['fuserid']))}" class="user_card" uid="{$vo['fuserid']}"><img width="48" height="48"src="{:U('Api/Avatar/index',array('uid'=>$vo['fuserid'],'size'=>48))}" onerror="this.src='{$Config.siteurl}statics/themes/default/member/images/noavatar.jpg'"/></a></div>
...
<script type="text/javascript" src="{$Config.siteurl}statics/themes/default/member/js/slot.js"></script> 
<script type="text/javascript" src="{$Config.siteurl}statics/themes/default/member/js/miniblog.js"></script> 
<script type="text/javascript" src="{$Config.siteurl}statics/themes/default/member/js/account.js"></script> 
<script type="text/javascript" src="{$Config.siteurl}statics/themes/default/member/js/jquery.emotEditor.js"></script>
...
<script type="text/javascript" src="{$Config.siteurl}statics/themes/default/member/js/card.js"></script>
</body>
</html>