  ...
  <div class="user_dialog_login">
    ...
    <div class="right_line">
      ...
      <div class="partner">
        ...
        <div class="qq"> <img src="{$Config.siteurl}statics/themes/default/member/images/icon/qqconnect.gif"> <a href="{:U('Api/Connectqq/index')}">用QQ账号登陆</a> </div>
        </if>
        <if condition=" $Member_config['sinawb_akey'] && $Member_config['sinawb_skey'] ">
        <div class="sina"> <img src="{$Config.siteurl}statics/themes/default/member/images/icon/sinaconnect.png"> <a href="{:U('Api/Connectsina/index')}">用新浪微博登陆</a> </div>
        </if>
      </div>
      <p></p>
    </div>
