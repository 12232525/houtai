...
<div id="modifyAvatar" class="profile" style="float: none;">
  ...
  <div class="avatar_box">
    ...
    <div class="myAvatar" style="margin-left: 0;"> <img class="avatar-160" id="my-avatar" width="160" height="160" src="{:U('Api/Avatar/index',array('uid'=>$uid,'size'=>180))}" onerror="this.src='{$Config.siteurl}statics/themes/default/member/images/noavatar.jpg'"/> </div>
