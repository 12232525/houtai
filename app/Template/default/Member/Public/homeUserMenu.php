...
<div class="user_menu" id="{$user_menu}">
  <div class="userinfo">
    ...
    <div class="face"> <img src="{:U('Api/Avatar/index',array('uid'=>$uid,'size'=>180))}" onerror="this.src='{$Config.siteurl}statics/themes/default/member/images/noavatar.jpg'" id="menu-avatar"> </div>
  </div>
