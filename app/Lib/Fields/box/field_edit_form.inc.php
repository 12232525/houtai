	        	...
	        	<table id="tbin" border="0" cellpadding="1" style="border-collapse: collapse" class="tableRow">
				    ...
				    <thead>
					    <tr id="trHead" class="HeadStyle">
					        <th align="center" style="width:80px;text-align: center;">排序<span class="red pl5">*</span></th>
					...
					?>
						<tr id="" class="MyRow">
					        <td id="tc1" align="center">
					            <input name="setting[options][sort][]" type="text" value="<?php echo $opRes['sort'][$i]; ?>" id="txtID" style="width:30px;" class="inputText" />
					        </td>
					        <td id="tc2" align="center">
					            <input name="setting[options][name][]" type="text" value="<?php echo $opRes['name'][$i]; ?>" id="txtDate" style="width:150px;" class="inputText" />
					        </td>
					        <td id="tc3" align="center">
					            <input name="setting[options][value][]" type="text" value="<?php echo $opRes['value'][$i]; ?>" id="txtDate" style="width:80px;" class="inputText" />
					        </td>
					        <td id="tc4" align="center">
					        	
					        	<div class="input-group">
									<input class="form-control" name="setting[options][color][]" placeholder="请选择颜色" value="<?php echo $opRes['color'][$i]; ?>" type="text">
									<span class="input-group-addon" style="width: 35px; border-left: medium none; background-color: <?php echo $opRes['color'][$i]; ?>"></span>
				    ...
				    <tr id="trDataRow1" class="MyRow">
				        <td id="tc1" align="center">
				            <input name="setting[options][sort][]" type="text" value="<?php echo $index; ?>" id="txtID" style="width:30px;" class="inputText" />
				        </td>
				        <td id="tc2" align="center">
