...
<table cellpadding="2" cellspacing="1" width="98%">
	<tr> 
	  ...
	  <input type='button' value="在列表中选择" onclick="omnipotent('selectid','index.php?g=Linkage&m=Linkage&a=public_get_list&isadmin=1','在列表中选择')" class="button">
		请到插件 > 模块 > 联动菜单 > 添加联动菜单</td>
    </tr>
	<tr>
	<td>显示方式</td>
	<td>
