  ...
  <form name="myform" action="{$config_siteurl}index.php" method="get" class="J_ajaxForm">
    ...
    <table width="100%" class="table_form">
        ...
        <tr>
			...
			<td>分类：{$catlist[$vo['catid']]['catname']} &nbsp;&nbsp;&nbsp;&nbsp;操作：<a class="J_ajax_del" href="{:U("Node/import_program_del",array("id"=>$vo['id']))}">删除</a> | <a href="{:U("Node/import_program_edit",array("id"=>$vo['id'],'nodeid'=>$nodeid,'type'=>$type,'ids'=>$ids   ))}">编辑</a></td>
		</tr>
        </volist>
	</table>
    </div>
