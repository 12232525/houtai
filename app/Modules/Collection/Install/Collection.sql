-- ----------------------------
-- Table structure for `app_collection_content`
-- ----------------------------
DROP TABLE IF EXISTS `app_collection_content`;
CREATE TABLE `app_collection_content` (
...
-- ----------------------------
-- Table structure for `app_collection_history`
-- ----------------------------
DROP TABLE IF EXISTS `app_collection_history`;
CREATE TABLE `app_collection_history` (
...
-- ----------------------------
-- Table structure for `app_collection_node`
-- ----------------------------
DROP TABLE IF EXISTS `app_collection_node`;
CREATE TABLE IF NOT EXISTS `app_collection_node` (
...
-- ----------------------------
-- Table structure for `app_collection_program`
-- ----------------------------
DROP TABLE IF EXISTS `app_collection_program`;
CREATE TABLE `app_collection_program` (
  `id` int(10) unsigned NOT NULL auto_increment,
