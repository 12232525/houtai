...
M("Menu")->add(array("parentid"=>$neirfb,"app"=>"Collection","model"=>"Node","action"=>"content_del","data"=>"","type"=>1,"status"=>2,"name"=>"删除已采集内容","remark"=>"","listorder"=>0));
M("Menu")->add(array("parentid"=>$neirfb,"app"=>"Collection","model"=>"Node","action"=>"import","data"=>"","type"=>1,"status"=>2,"name"=>"导入内容","remark"=>"","listorder"=>0));
M("Menu")->add(array("parentid"=>$neirfb,"app"=>"Collection","model"=>"Node","action"=>"import_content","data"=>"","type"=>1,"status"=>2,"name"=>"导入内容到模型入库","remark"=>"","listorder"=>0));
