...
<div class="wrap">
  ...
  <div class="prompt_text">
    <ol>
      ...
      <li>关于计划任务的添加，您需要上传相应执行文件到 app/Lib/Cron/目录下,文件名必须为AppCMSxx.php形式</li>
    </ol>
  </div>
      ...
      <table width="100%">
        ...
        <tr>
          ...
          <td><select id="J_type_select" name="type" class="mr10">
              ...
              <option value="1" <if condition=" '1' eq $type ">selected</if>>系统分类刷新任务</option>
          ...
          <td><div class="fun_tips">刷新分类：AppCMSRefresh_category.php，属性自定义页面：AppCMSRefresh_custompage.php</div></td>
        </tr>
