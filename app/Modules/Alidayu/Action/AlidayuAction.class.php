<?php
class AlidayuAction extends AdminbaseAction {

    public $sms_param = null;
    public $error_msg;
	public $addonsPath;
	
    public function _initialize() {
        parent::_initialize();
		$this->addonsPath = APP_PATH . 'Modules/Alidayu';
		
        include $this->addonsPath . "/alidayu/TopSdk.php";
        
        $this->config = $this->addonsPath . '/Config/Config.php';
