...
<title>添加新内容 - 系统后台 - {$Config.sitename} - by AppCMS</title>
...
<div class="wrap J_check_wrap">
  <div class="navpar">	
	  <div class="nav">
	    <ul class="cc">
	      <li class="current"><a href="http://www.abc.com/index.php?m=Content&a=classlist&catid=2">模型预览</a></li>
	    </ul>
	  </div>
  </div>
  <form name="myform" id="myform" action="{:U("Contents/Contents/add")}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
...
?>
          <tr>
              <td><b><?php echo $info['name'] ?></b><?php if ($info['star']) { ?><font color="red">*</font><?php } ?>
              </td>
          </tr>
          <tr>
