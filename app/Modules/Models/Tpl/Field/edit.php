...
<div class="wrap J_check_wrap">
  ...
  <table width="100%" class="table_form">
      ...
      <tr>
        ...
        <td><input type="text" name="field" id="field" size="30" class="input" value="{$data.field}" <if condition=" !$isEditField "> disabled</if>></td>
      </tr>
      <tr>
      ...
      <tr>
          <th><strong>作为可导出字段</strong></th>
          <td><input type="radio" name="isexport" value="1" id="field_allow_export1" <if condition="$data['isexport'] eq '1'"> checked</if> >
              是
              <input type="radio" name="isexport" value="0" id="field_allow_export0" <if condition="$data['isexport'] eq '0'"> checked</if> >
              否</td>
      </tr>
      <tr>
        <th><strong>在前端页面中显示</strong></th>
      ...
      <tr> 
        <th><strong>作为列表字段显示</strong></th>
        <td>
        	<input type="radio" name="islistshow" value="1" <if condition="$data['islistshow'] eq '1'"> checked</if>/> 是 
        	<input type="radio" name="islistshow" value="0" <if condition="$data['islistshow'] eq '0'"> checked</if>/> 否</td>
      </tr>
      <tr> 
        <th><strong>列表显示字段列宽度</strong></th>
        <td>
        	<input type="text" name="showwidth" value="{$data.showwidth}" size="10" class="input"> px
        </td>		
      </tr>
      <tr> 
        <th><strong>列表显示对齐方式</strong></th>
        <td>
        	<input type="radio" name="isalign" value="left" <if condition="$data['isalign'] eq 'left'"> checked</if>/> 居左 
        	<input type="radio" name="isalign" value="center" <if condition="$data['isalign'] eq 'center'"> checked</if>/> 居中
        	<input type="radio" name="isalign" value="right" <if condition="$data['isalign'] eq 'right'"> checked</if>/> 居右
        </td>
      </tr>
      <tr> 
        <th><strong>是否可点击</strong></th>
        <td>
        	<input type="radio" name="isclick" value="1" <if condition="$data['isclick'] eq '1'"> checked</if>/> 是 
        	<input type="radio" name="isclick" value="0" <if condition="$data['isclick'] eq '0'"> checked</if>/> 否</td>
      </tr>
      <tr> 
        <th><strong>点击对应的URL</strong></th>
        <td><input type="text" name="clickurl" value="{$data.clickurl}" size="120" class="input"></td>
      </tr>
      <tr> 
        <th><strong>参数字段名</strong><br>跳转链接判断的主要关键字段</th>
        <td><input type="text" name="param" value="{$data.param}" size="120" class="input"></td>
      </tr>
    </table>
  </div>
  <div class="btn_wrap">
