...
<div class="wrap J_check_wrap">
  ...
  <table width="100%" class="table_form contentWrap">
      ...
      <tr>
        ...
        <td><input type="text" name="field" id="field" size="30" class="input"></td>
      </tr>
      <tr>
      ...
      <tr>
          ...
          <td><input type="radio" name="isexport" value="1" id="field_allow_export1">
              是
              <input type="radio" name="isexport" value="0" id="field_allow_export0" checked>
              否
          </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
        	<input type="radio" name="islistshow" value="1"/> 是 
        	<input type="radio" name="islistshow" value="0" checked/> 否</td>
      </tr>
      <tr> 
        <th><strong>列表显示字段列宽度</strong></th>
        <td>
        	<input type="text" name="showwidth" value="" size="10" class="input"> px
        </td>		
      </tr>
      <tr> 
        <th><strong>列表显示对齐方式</strong></th>
        <td>
        	<input type="radio" name="isalign" value="left"/> 居左 
        	<input type="radio" name="isalign" value="center" checked/> 居中
        	<input type="radio" name="isalign" value="right"/> 居右
        </td>
      </tr>
       <tr> 
        <th><strong>是否可点击</strong></th>
        <td>
        	<input type="radio" name="isclick" value="1"/> 是 
        	<input type="radio" name="isclick" value="0" checked/> 否
        </td>
      </tr>
      
      <tr> 
        <th><strong>点击对应的URL</strong></th>
        <td><input type="text" name="clickurl" size="120" class="input"></td>
      </tr>
      <tr> 
        <th><strong>参数字段名</strong><br>跳转链接判断的主要关键字段</th>
        <td><input type="text" name="param" size="120" class="input"></td>
      </tr>
