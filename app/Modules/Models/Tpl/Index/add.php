  ...
  <Admintemplate file="Common/Nav"/>
    ...
    <div class="mb10">
        <ul id="navList" class="nav nav-primary nav-justified f14">
            <li class="active"><a href="{:U("Models/Index/add")}">全新建立模型</a></li>
            <li><a href="{:U("Models/Index/copy")}">复制已有模型</a></li>
        </ul>
    </div>
  ...
  <form action="{:U("Index/add")}" method="post" class="J_ajaxForm" >
    <div class="table_full">
      <table width="100%"  class="table_form">
        ...
        <tr id="retab" class="hide"> 
	        <th>关联表名</th>
	        <td>
	            <select name="rel_table_id" id="st_name">
