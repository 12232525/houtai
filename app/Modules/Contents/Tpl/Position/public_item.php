        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="center"><a href="{$vo.data.url}" target="_blank">原文</a> | <a onClick="javascript:openwinx('{:U("Contents/Contents/edit",array("catid"=>$vo['catid'],"id"=>$vo['id']  ))}','')" href="javascript:;">原文编辑</a> | <a href="javascript:item_manage({$vo.id},{$vo.posid}, {$vo.modelid},'{$vo.data.title}')">信息管理</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
