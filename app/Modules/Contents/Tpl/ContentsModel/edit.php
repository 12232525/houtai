...
<title>编辑{$category.catname} - 系统后台 - {$Config.sitename} - by AppCMS</title>
...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" id="myform" action="{:U("Contents/ContentsModel/edit")}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
							        ...
							        button:[
										{
											name: '添加一篇新文章？',
											callback:function(){
												window.location.href = "{:U('Contents/add',array('modid'=>$modid))}";
												return true;
											},
											focus: true
										},{
...
function public_lock_renewal(){
    $.get("{:U('Contents/ContentsModel/public_lock_renewal',array('modid'=>$modid,'id'=>$id))}");
}
</script>
</body>
</html>