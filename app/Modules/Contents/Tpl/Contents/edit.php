...
<title>编辑：《{$data.title}》 - 系统后台 - {$Config.sitename} - by AppCMS</title>
...
<div class="wrap J_check_wrap">
  ...
  <div class="navpar">
	  <div class="nav">
	    <ul class="cc">
	      <li class="current"><a href="{:U('Contents/classlist', array('catid'=>$catid)  )}">{$category.catname}列表</a></li>
	    </ul>
	  </div>
  </div>
  
  <div class="h_a">重要提示</div>
  <div class="prompt_text"> 
    <p>请不要发布违反法律的文字内容！</p>
   </div>
  <form name="myform" id="myform" action="{:U("Contents/Contents/edit")}" method="post" class="J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
...
?>
  ...
  <div class="btn_wrap" style="z-index:999;text-align: center;">
    <div class="btn_wrap_pd">
      ...
      <button class="btn J_ajax_close_btn" type="button">关闭</button>
    </div>
  </div>
  </form>
</div>
												...
												Wind.use("artDialog", function () {
														art.dialog({
																...
																button:[
															{
																name: '添加一篇新文章？',
																callback:function(){
																	window.location.href = "{:U('Contents/add',array('catid'=>$catid))}";
																	return true;
																},
																focus: true
															},{
...
function public_lock_renewal(){
    $.get("{:U('Contents/Contents/public_lock_renewal',array('catid'=>$catid,'id'=>$id))}");
}
</script>
</body>
</html>