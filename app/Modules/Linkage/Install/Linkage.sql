...
-- 表的结构 `app_linkage`
--
DROP TABLE IF EXISTS `app_linkage`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=3378 COMMENT='联动菜单';
...
INSERT INTO `hr_linkage` (`linkageid`, `name`, `style`, `parentid`, `child`, `arrchildid`, `keyid`, `listorder`, `description`, `setting`, `siteid`) VALUES
