        ...
        <table cellpadding="0" cellspacing="0" class="table_form" width="100%">
          <tbody>
            ...
            <tr>
              <td>参数</td>
              <td>
              	<input type="text" class="input length_5" name="data" value="{$data}">
               	 例groupid=1&amp;type=2
              </td>
            </tr>
            <tr>
              <td>选择图标类型</td>
              <td>
				<input type="radio" name="icontype" id="icontype1" value="1" checked="checked" /> 通用图标字体fontawesome
				<input class="ml10" type="radio" name="icontype" id="icontype2" value="2"/> 阿里开源图标iconfont
				<input class="ml10" type="radio" name="icontype" id="icontype3" value="3"/> 图片上传
              </td>
            </tr>
            <tr>
              <td>类型1：通用图标字体</td>
              <td>
         		<div class="pull-left input-group" style="width: 300px;">
					<input value="" name="icon" id="icon" class="form-control" autocomplete="off" type="text">
              ...
              <td>
         		<div class="pull-left input-group" style="width: 300px;">
					<div  style="text-align: left;">
						...
						<img src='/statics/images/icon/upload-pic.png' id='logo_preview' width='48' height='48' style='cursor:hand' /></a> 
            ...
            <tr>
              <td>是否跳转</td>
              <td>
                <input name="redirect" type="checkbox" id="redirect" class="switch inputText" <if condition="$redirect eq 1">checked="checked"</if>/>                           
            ...
            <tr>
              <td>显示状态</td>
              <td>
                <input name="status" type="checkbox" value="1" id="status" class="switch inputText" <if condition="$status eq 1">checked="checked"</if>/>
              </td>
            </tr>
            <tr>
              <td>类型</td>
