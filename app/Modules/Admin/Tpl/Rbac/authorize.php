...
<title>系统后台 - AppCMS内容管理系统 - by AppCMS</title>
<link href="{$config_siteurl}statics/css/admin_style.css" rel="stylesheet" />
<link href="{$config_siteurl}statics/css/button.css" rel="stylesheet" />
  ...
  <form class="J_ajaxForm" action="{:U('Rbac/authorize')}" method="post">
    ...
    <div class="">
      <div class="btn_wrap_pd">
        ...
        <button class="btn btn-primary mr10 J_ajax_submit_btn" type="submit">授权</button>
      </div>
    </div>
  </form>
</div>
