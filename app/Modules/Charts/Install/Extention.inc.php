...
$parentid = M("Menu")->add(array(
    ...
    //模块目录名称，也是项目名称
    "app" => "Charts",
    //文件名称，比如ChartsAction.class.php就填写 Charts
    "model" => "Charts",
    //方法名称
    "action" => "index",
    //附加参数 例如：a=12&id=777
...
M("Menu")->add(array("parentid"=>$parentid,"app"=>"Charts","model"=>"Charts","action"=>"index","data"=>"","type"=>1,"status"=>1,"name"=>"数据图表","remark"=>"","listorder"=>0));
?>