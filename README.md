#交流
* 网址：[http://www.it100.net](http://www.it100.net)

----
#AppCMS简介 
* AppCMS 基于[ThinkPHP](http://www.thinkphp.cn)框架开发，采用独立分组的方式开发的内容管理系统。；
...
## 界面预览：
 ![mahua](http://file.it100.net/d/file/contents/2013/01/50f8dfd9cf91d.jpg)