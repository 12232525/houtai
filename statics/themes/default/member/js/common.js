...
var user = {
    ...
    loginInit: function (tid) {
        ...
        $("#submit2").click(function () {
            ...
            $.post(_config['domainSite'] + "index.php?g=Member&m=Public&a=public_doLogin", "username=" + escape($loginName.val()) + "&password=" + escape($password.val()) + "&cookieTime=" + escape(cookieTime) + "&vCode=" + escape($vCode.val()) + '&escape=1',
                function (data) {
                    if (data['error'] == 10005) {
