    ...
    init: function () {
		...
		$username.focus(function () {
            ...
            $.ajax({
                ...
                url: _config['domainSite'] + "index.php?g=Member&m=Public&a=public_checkUsername",
                data: {
        ...
        $remail.focus(function () {
            ...
            $.ajax({
                type: "POST",
                global: false, // 禁用全局Ajax事件.
                url: _config['domainSite'] + "index.php?g=Member&m=Public&a=public_checkEmail",
                data: {
                    email: $remail.val()
                },
                dataType: "json",
        ...
        $rnickname.focus(function () {
            ...
            $.ajax({
                type: "POST",
                global: false, // 禁用全局Ajax事件.
                url: _config['domainSite'] + "index.php?g=Member&m=Public&a=public_checkNickname",
                data: {
		...
		$submit.click(function () {
            ...
            if (!numError) {
                $.ajax({
                    type: "POST",
                    global: false, // 禁用全局Ajax事件.
                    url: _config['domainSite'] + "index.php?g=Member&m=Public&a=public_doRegister",
                    data: {
						username: $username.val(),
