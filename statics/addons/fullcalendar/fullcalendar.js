...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content" title="'+event.desc+'">' +
					(this.isRTL ?
		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					...
					var viewSpec;
					var buttonClick;
					var overrideText; // text explicitly set by calendar's constructor options. overcomes exam
					var defaultText;
					var themeIcon;
					var normalIcon;
					var innerHtml;
					...
					if (buttonName == 'title') {
						...
						if ((customButtonProps = (calendar.options.customButtons || {})[buttonName])) {
							...
							overrideText = ''; // exam will override text
