...
(function() {
	Formbuilder.registerField('text', {
		...
		defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '单行文本';
...
(function() {
	Formbuilder.registerField('paragraph', {
		...
		edit: "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
		addButton: "<span class=\"symbol\"><i class=\"fa fa-bars\"></i></span> 多行文本",
		defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '多行文本';
			attrs.field_options.size = 'small';
			return attrs;
		}
	});
...
(function() {
	Formbuilder.registerField('radio', {
		...
		addButton: "<span class=\"symbol\"><i class=\"fa fa-dot-circle-o\"></i></span> 单选",
		defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '单选';
...
(function() {
	Formbuilder.registerField('checkboxes', {
		order: 20,
		view: "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div class='checkbox_lt'>\n    <label class='fb-option'>\n      <input type='checkbox' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='checkbox' />\n      其他\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
		edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
		addButton: "<span class=\"symbol\"><i class=\"fa fa-check-square-o\"></i></span> 多选",
		defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '多选';
			attrs.field_options.options = [{
				label: "",
				checked: false
			}, {
...
(function() {
	Formbuilder.registerField('dropdown', {
		...
		defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '下拉菜单';
			attrs.field_options.options = [{
				label: "",
				checked: false
			}, {
...
(function() {
	Formbuilder.registerField('number', {
		...
		addButton: "<span class=\"symbol\"><i class='fa fa-sort-numeric-asc'></i></span> 数字",
        defaultAttributes: function(attrs) {
...
(function() {
	Formbuilder.registerField('email', {
        ...
        defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '邮箱';
            return attrs;
        }
	});
...
(function() {
	Formbuilder.registerField('phone', {
		...
		edit: "",
		addButton: "<span class=\"symbol\"><i class=\"fa fa-phone\"></i></span> 手机",
        defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '手机';
            return attrs;
        }
	});
...
(function() {
	Formbuilder.registerField('sex', {
		...
		view: "<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n  <div class='radio_lt'>\n    <label class='fb-option'>\n      <input type='radio' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && 'checked' %> onclick=\"javascript: return false;\" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class='other-option'>\n    <label class='fb-option'>\n      <input type='radio' />\n      Other\n    </label>\n\n    <input type='text' />\n  </div>\n<% } %>",
		edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
		addButton: "<span class=\"symbol\"><i class=\"fa fa-male\"></i></span> 性别",
		defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '性别';
			attrs.field_options.options = [{
				label: "男",
				checked: false
			}, {
...
(function() {
	Formbuilder.registerField('address', {
		order: 50,
		view: "<div class='input-line'>\n  <span class='city'>\n  <label>城市</label><input type='text' />\n  </span>\n\n  <span class='state'>\n   <label>省/市/地区</label><input type='text' />\n  </span>\n</div>\n\n<div class='input-line'>\n  <span class='street'>\n  <label>地址</label><input type='text' />\n  </span>\n</div>\n\n<div class='input-line'>\n  <span class='zip'>\n    <label>邮编</label><input type='text' />\n  </span>\n\n  </div>",
		edit: "",
		addButton: "<span class=\"symbol\"><i class=\"fa fa-map-marker\"></i></span> 地址",
        defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '地址';
            return attrs;
        }
	});
...
(function() {
	Formbuilder.registerField('website', {
        ...
        defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '网址';
            return attrs;
        }
	});
...
(function() {
	Formbuilder.registerField('price', {
        ...
        defaultAttributes: function(attrs) {
            attrs[Formbuilder.options.mappings.LABEL] = '价格';
            return attrs;
        }
	});
...
this["Formbuilder"]["templates"]["partials/left_side"] = function(obj) {
	...
	var __t, __p = '',
		__e = _.escape;
	with(obj) {
		__p += '<div class=\'fb-left component-list\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>通用控件</a></li>\n </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' + ((__t = (Formbuilder.templates['partials/add_field']())) == null ? '' : __t) + '\n    </div>\n</div>';
...
this["Formbuilder"]["templates"]["partials/right_side"] = function(obj) {
	...
	var __t, __p = '',
		__e = _.escape;
	with(obj) {
		__p += '<div class=\'fb-left content-list\'>\n  <div class=\'fb-no-response-fields\'><div  class="fb-no-response-cal">暂无表单项</div></div>\n  <div class=\'fb-response-fields\'></div>\n</div>\n';

        __p += '<div class=\'fb-right attr-list\'>\n  <ul class=\'fb-tabs\'>\n <li><a data-target=\'#editField\'>控件属性</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    '  + ((__t = (Formbuilder.templates['partials/edit_field']())) == null ? '' : __t) + '\n  </div>\n</div>';
...
this["Formbuilder"]["templates"]["partials/save_button"] = function(obj) {
	...
	var __t, __p = '',
		__e = _.escape;
	with(obj) {
		__p += '<div class=\'fb-save-wrapper\'>\n  <button class=\'js-save-form btn btn-primary\'></button>\n</div>';
